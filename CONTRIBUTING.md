...
Welcome to the [BillkolosSoft-erp-crm](<[BillkolosSoft-erp-crm](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm)>) repository! We're excited that you're interested in contributing. Please take a moment to review this document to ensure a smooth collaboration process.
...
- please make sure it was not asked before here [issues](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm/issues).
- make sure it is not work in progress here [pull requests](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm/pulls).
- you can then [create an issue](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm/issues/new/choose) with the following information:
...
Thank you for contributing to [BillkolosSoft-erp-crm](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm) dont forget to give us a :star: !
