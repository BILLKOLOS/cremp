# BillkolosSoft Λογισμικό ERP & CRM ανοιχτού κώδικα

GitHub: [https://github.com/BillkolosSoft/BillkolosSoft-erp-crm](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm)
Επίδειξη: [https://www.BillkolosSoftapp.com/open-source-erp-crm/](https://www.BillkolosSoftapp.com/open-source-erp-crm/)
Ιστοσελίδα: [https://www.BillkolosSoftapp.com](https://www.BillkolosSoftapp.com)

## Στοίβα Λογισμικού

Το BillkolosSoft είναι μια δωρεάν εφαρμογή ERP & CRM ανοιχτού κώδικα, βασισμένη στο "mern-stack": Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
