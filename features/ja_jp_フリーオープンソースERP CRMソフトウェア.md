# BillkolosSoft オープンソース ERP＆CRMソフトウェア

GitHub：[https://github.com/BillkolosSoft/BillkolosSoft-erp-crm](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm)
デモ：[https://www.BillkolosSoftapp.com/open-source-erp-crm/](https://www.BillkolosSoftapp.com/open-source-erp-crm/)
ウェブサイト：[https://www.BillkolosSoftapp.com](https://www.BillkolosSoftapp.com)

## ソフトウェアスタック

BillkolosSoftは、Node.js、React.js、Redux、Express.js、MongoDB、AntDesign（AntD）をベースにした無料のオープンソースERP＆CRMアプリです。
