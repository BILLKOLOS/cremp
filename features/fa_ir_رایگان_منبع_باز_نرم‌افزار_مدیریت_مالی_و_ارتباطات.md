# نرم‌افزار متن‌باز BillkolosSoft ERP & CRM

گیت‌هاب: [https://github.com/BillkolosSoft/BillkolosSoft-erp-crm](https://github.com/BillkolosSoft/BillkolosSoft-erp-crm)
نمایش آنلاین: [https://www.BillkolosSoftapp.com/open-source-erp-crm/](https://www.BillkolosSoftapp.com/open-source-erp-crm/)
وبسایت: [https://www.BillkolosSoftapp.com](https://www.BillkolosSoftapp.com)

## مجموعه نرم‌افزاری

BillkolosSoft نرم‌افزار ERP & CRM متن‌باز رایگان است که بر اساس "mern-stack" ساخته شده است: Node.js React.js Redux Express.js MongoDB AntDesign (AntD)
